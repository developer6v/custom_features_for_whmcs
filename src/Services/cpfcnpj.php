  ...
  <script>
    ...
    (function(){
      ...
      function maskCpfCnpj($el){
        ...
        var docValid = (len === 11 || len === 14);
        window.__setDocLen('other', len); // Atualiza a contagem no agregador

        // Habilita ou desabilita o botão baseado na quantidade de dígitos
        window.__checkout.doc = docValid;
        window.__recomputeCheckout && window.__recomputeCheckout();
      }
      ...
      jQuery(function(){
        var checkExist = setInterval(function() {
          var $field = jQuery('#cl_custom_field_1'); // Assumindo que é o campo de CPF/CNPJ no painel
          if ($field.length) {
